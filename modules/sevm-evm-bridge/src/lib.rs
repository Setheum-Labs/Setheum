...
use hex_literal::hex;
use sevm::{ExitReason, ExitSucceed};
use primitive_types::H256;
use sp_core::{H160, U256};
use sp_runtime::SaturatedConversion;
use support::{SEVMBridge as SEVMBridgeTrait, ExecutionMode, InvokeContext, EVM};
...
impl<T: Config> SEVMBridgeTrait<AccountIdOf<T>, BalanceOf<T>> for Pallet<T> {

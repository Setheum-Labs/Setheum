...
pub const X_TOKEN_ID: CurrencyId = CurrencyId::Token(TokenSymbol::JUSD);
...
pub type SignedExtra = sevm::SetEvmOrigin<Runtime>;
...
frame_support::construct_runtime!(
	...
	UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		EVM: sevm::{Pallet, Config<T>, Call, Storage, Event<T>},
...
impl ExtBuilder {
	...
	pub fn build(self) -> sp_io::TestExternalities {
		...
		sevm::GenesisConfig::<Runtime> { accounts }
			.assimilate_storage(&mut t)
			.unwrap();

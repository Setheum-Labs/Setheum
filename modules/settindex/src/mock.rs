...
//! Mocks for the settindex module.
...
pub const JUSD_JCHF_PAIR: TradingPair = TradingPair(JUSD, JCHF);
pub const JUSD_DNAR_PAIR: TradingPair = TradingPair(JUSD, DNAR);
	...
	fn default() -> Self {
		Self {
			endowed_accounts: vec![
				(ALICE, JUSD, 1_000_000_000_000_000_000u128),
				(BOB, JUSD, 1_000_000_000_000_000_000u128),
...
impl ExtBuilder {
	...
	pub fn initialize_enabled_trading_pairs(mut self) -> Self {
		self.initial_enabled_trading_pairs = vec![JUSD_DNAR_PAIR, JUSD_JCHF_PAIR, DNAR_JCHF_PAIR];
		self
	}
	...
	pub fn initialize_added_liquidity_pools(mut self, who: AccountId) -> Self {
		self.initial_added_liquidity_pools = vec![(
			who,
			vec![
				(JUSD_DNAR_PAIR, (1_000_000u128, 2_000_000u128)),
				(JUSD_JCHF_PAIR, (1_000_000u128, 2_000_000u128)),

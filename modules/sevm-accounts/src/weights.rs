...
//! Autogenerated weights for sevm_accounts
//!
...
/// Weight functions needed for sevm_accounts.
pub trait WeightInfo {
	fn claim_account() -> Weight;
	fn claim_default_account() -> Weight;
}

/// Weights for sevm_accounts using the setheum node and recommended hardware.

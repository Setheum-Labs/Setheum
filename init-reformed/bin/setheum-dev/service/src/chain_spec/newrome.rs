...
fn testnet_genesis(
	...
	use newrome_runtime::{
		...
		OrmlNFTConfig, SessionConfig, StakerStatus, StakingConfig, StakingPoolConfig, SudoConfig,
		SystemConfig, TechnicalCommitteeMembershipConfig, TokensConfig, TradingPair, VestingConfig, DNAR, AUSD, 
	...
	newrome_runtime::GenesisConfig {
			...
			endowed_accounts: endowed_accounts
				...
				.flat_map(|x| {
					vec![
						...
						(x.clone(), DNAR, 1_000_000 * dollar(DNAR)),
					]
				})
				.collect(),
		},
		...
		module_dex: DexConfig {
			...
			initial_added_liquidity_pools: vec![(
				get_account_id_from_seed::<sr25519::Public>("Alice"),
				vec![
					(TradingPair::new(JUSD, JEUR), (1_000_000u128, 2_000_000u128)),
					(TradingPair::new(JUSD, JCHF), (1_000_000u128, 2_000_000u128)),
...
fn newrome_genesis(
	...
	use newrome_runtime::{
		...
		DNAR, AUSD, BABE_GENESIS_EPOCH_CONFIG,
	};
	#[cfg(feature = "std")]
	use sp_std::collections::btree_map::BTreeMap;
	...
	newrome_runtime::GenesisConfig {
		...
		orml_tokens: TokensConfig {
			endowed_accounts: vec![
				(root_key.clone(), DNAR, 1_000_000 * dollar(DNAR)),
				(root_key, JUSD, 1_000_000 * dollar(JUSD)),
			],
		},
		module_airdrop: AirDropConfig {
			airdrop_accounts: {

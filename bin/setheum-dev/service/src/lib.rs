...
//! setheum dev service. Specialized wrapper over substrate service.
	...
	Executor: NativeExecutionDispatch + 'static,
{
	...
	let (rpc_extensions_builder, rpc_setup) = {
		...
		let rpc_extensions_builder = move |deny_unsafe, subscription_executor| -> setheum_rpc::RpcExtension {
...
> {
	...
	if config.chain_spec.isnewrome() {
		#[cfg(feature = "with-newrome-runtime")]
		{
			let PartialComponents {
				client,

...
//! Autogenerated weights for setheum_staking
//!
...
/// Weight functions needed for setheum_staking.
...
/// Weights for setheum_staking using the Substrate node and recommended hardware.

...
// --heap-pages=4096
// --output=./lib-serml/serp-auction/src/weights.rs
...
/// Weight functions needed for serp_auction.
...
/// Weights for serp_auction using the Setheum node and recommended hardware.

...
//! Autogenerated weights for serp_staking
//!
...
/// Weight functions needed for serp_staking.
...
/// Weights for serp_staking using the Substrate node and recommended hardware.

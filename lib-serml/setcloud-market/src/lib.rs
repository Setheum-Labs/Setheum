...
decl_error! {
    ...
    pub enum Error for Module<T: Config> {
        /// Don't have enough currency(SETM) to finish the extrinsic(transaction).
        /// Please transfer some SETM into this account.
...
decl_module! {
    pub struct Module<T: Config> for enum Call where origin: T::Origin {
        ...
        /// The staking ratio for how much SETM into staking pot.
        const StakingRatio: Perbill = T::StakingRatio::get();

        /// The storage ratio for how much SETM into storage pot.

...
//! Autogenerated weights for token_registry
//!
...
/// Weight functions needed for token_registry.
pub trait WeightInfo {
	fn register_erc20_asset() -> Weight;
	fn update_erc20_asset() -> Weight;
}

/// Weights for token_registry using the Setheum node and recommended hardware.

...
//! Autogenerated weights for setheum_democracy
//!
...
/// Weight functions needed for setheum_democracy.
...
/// Weights for setheum_democracy using the Substrate node and recommended hardware.

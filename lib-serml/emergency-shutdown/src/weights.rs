...
// --steps=50
// --repeat=20
// --pallet=setheum_emergency_shutdown
// --extrinsic=*
// --execution=wasm
...
/// Weight functions needed for setheum_emergency_shutdown.
pub trait WeightInfo {
	fn emergency_shutdown(c: u32, ) -> Weight;
	fn open_reserve_refund() -> Weight;
	fn refund_reserves(c: u32, ) -> Weight;
}

/// Weights for setheum_emergency_shutdown using the Setheum node and recommended hardware.

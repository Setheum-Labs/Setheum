...
//! Autogenerated weights for serp_mint
//!
...
// --heap-pages=4096
// --output=./modules/serp-mint/src/weights.rs
...
/// Weight functions needed for serp_mint.
...
/// Weights for serp_mint using the Setheum node and recommended hardware.

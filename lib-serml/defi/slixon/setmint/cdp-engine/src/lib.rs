...
use sp_runtime::{
	...
	traits::{Bounded, One, Saturating, StaticLookup, Zero},
...
use sp_std::prelude::*;
use support::{
	CDPTreasury, CDPTreasuryExtended, DEXManager, EmergencyShutdown,
	ExchangeRate, Price, PriceProvider, Rate, Ratio, RiskManager, SwapLimit,
};

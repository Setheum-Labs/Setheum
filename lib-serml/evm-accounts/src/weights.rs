...
//! Autogenerated weights for setheum_evm_accounts
//!
...
/// Weight functions needed for setheum_evm_accounts.
pub trait WeightInfo {
	fn claim_account() -> Weight;
	fn claim_default_account() -> Weight;
}

/// Weights for setheum_evm_accounts using the Setheum node and recommended hardware.

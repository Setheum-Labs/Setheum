...
//! Autogenerated weights for setheum_prices
//!
...
/// Weight functions for setheum_prices.
pub struct WeightInfo<T>(_);
impl<T: frame_system::Config> setheum_prices::WeightInfo for WeightInfo<T> {

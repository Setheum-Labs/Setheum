...
parameter_types! {
	pub const BlockHashCount: BlockNumber = 900; // mortal tx can be valid up to 4 hour after signing
...
parameter_types! {
	...
	pub FiatCurrencyIds: Vec<CurrencyId> = vec![USD, EUR, GBP, CHF, SAR, KWD, JOD, BHD, KYD, OMR, GIP];
}

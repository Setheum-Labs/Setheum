...
pub type DOTSCurrency = orml_currencies::Currency<Runtime, GetLiquidCurrencyId>;
...
impl Default for ExtBuilder {
	fn default() -> Self {
		Self {
			endowed_accounts: vec![(ALICE, DOTS, 1000), (BOB, DOTS, 1000)],
		}
	}
}

...
//! Autogenerated weights for evm_accounts
//!
...
// --heap-pages=4096
// --output=./serml/evm-accounts/src/weights.rs
...
/// Weight functions needed for evm_accounts.
pub trait WeightInfo {
	fn claim_account() -> Weight;
	fn claim_default_account() -> Weight;
}

/// Weights for evm_accounts using the Setheum node and recommended hardware.

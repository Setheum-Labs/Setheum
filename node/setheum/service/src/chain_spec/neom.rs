...
fn neom_session_keys(grandpa: GrandpaId, babe: BabeId) -> neom_runtime::SessionKeys {
...
pub fn latest_neom_config() -> Result<ChainSpec, String> {
	...
	properties.insert("tokenSymbol".into(), "NEOM".into());
	...
	Ok(ChainSpec::from_genesis(
		...
		vec![
			//TODO
			"/dns/testnet-bootnode-1.neom.laminar.one/tcp/30333/p2p/12D3KooWAFUNUowRqCV4c5so58Q8iGpypVf3L5ak91WrHf7rPuKz"
				.parse()
				.unwrap(),
		],

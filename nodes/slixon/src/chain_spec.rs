...
use slixon_runtime::BABE_GENESIS_EPOCH_CONFIG;
...
pub fn development_config() -> Result<ChainSpec, String> {
	let wasm_binary = slixon_runtime::WASM_BINARY.ok_or_else(|| "WASM binary not available".to_string())?;
...
pub fn live_mainnet_config() -> Result<ChainSpec, String> {
	ChainSpec::from_json_bytes(&include_bytes!("../../../resources/chain_spec_slixon_raw.json")[..])
}
...
fn dev_genesis(
	...
	GenesisConfig {
		...
		treasury: Default::default(), // Main Treasury (Slixon Treasury)
		tokens: TokensConfig {
...
fn mainnet_genesis(
	...
	GenesisConfig {
		...
		authority_discovery: AuthorityDiscoveryConfig { keys: vec![] },
		im_online: Default::default(),
		treasury: Default::default(), // Slixon Treasury
		tokens: TokensConfig {
			balances: vec![
		...
		vesting: VestingConfig {
			vesting: vec![
				...
				(foundation.clone(), USDW, 313, 1, 15_336_000, setr_foundation_vesting),
...
pub fn slixon_properties() -> Properties {

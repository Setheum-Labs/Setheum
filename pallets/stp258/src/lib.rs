...
use codec::{Decode, Encode, Codec, FullCodec};
use core::cmp::Ord;
use sp_runtime::Perbill;
use frame_support::{
	decl_error, decl_event, decl_module, decl_storage,
	traits::{Get, BalanceStatus, LockIdentifier},
	sp_runtime::{
...
/// Abstraction over a fungible multi-stablecoin system.
...
/// A fungible multi-stablecoin system whose accounts can have liquidity
/// restrictions.
pub trait SettLockableCurrency<AccountId>: SettCurrency<AccountId> {
...
/// A fungible multi-stablecoin system where funds can be reserved from the user.
pub trait SettReservableCurrency<AccountId>: SettCurrency<AccountId> {
...
/// The type used to represent the account balance for the Setheum SettCurrency.

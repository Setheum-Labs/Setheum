...
//! Autogenerated weights for senterprise_extension
//!
//! THIS FILE WAS AUTO-GENERATED USING THE SUBSTRATE BENCHMARK CLI VERSION 4.0.0-dev
//! DATE: 2024-01-31, STEPS: `20`, REPEAT: 5, LOW RANGE: `[]`, HIGH RANGE: `[]`
//! EXECUTION: , WASM-EXECUTION: Compiled, CHAIN: Some("./senterprise-benchmark-chainspec.json"), DB CACHE: 1024

// Executed Command:
// target/production/setheum-node
// benchmark
// pallet
// --chain=./senterprise-benchmark-chainspec.json
// --pallet=senterprise_extension
// --extrinsic=*
// --steps=20
// --repeat=5
// --template=.maintain/pallet-weight-template.hbs
// --wasm-execution=compiled
// --output=senterprise-extension/src/backend/weights.rs
...
/// Weight functions needed for senterprise_extension.
...
/// Benchmark results for senterprise_extension.
trait BenchmarkInfo {
...
/// Weights for senterprise_extension using the Substrate node and recommended hardware.

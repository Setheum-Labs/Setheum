...
runtime_benchmarks! {
	...
	verify {
		assert_last_event(edfis_swap_module::Event::EnableTradingPair{trading_pair: trading_pair}.into());
	}
	...
	verify {
		assert_last_event(edfis_swap_module::Event::DisableTradingPair{trading_pair}.into());
	}
	...
	verify {
		assert_last_event(edfis_swap_module::Event::ListProvisioning{trading_pair: trading_pair}.into());
	}
	...
	verify {
		assert_last_event(edfis_swap_module::Event::ProvisioningToEnabled{trading_pair, pool_0: 100 * dollar(trading_pair.first()), pool_1: 100 * dollar(trading_pair.second()), share_amount: 200 * dollar(trading_pair.first())}.into())
	}
	...
	verify{
		assert_last_event(edfis_swap_module::Event::AddProvision{who: founder, currency_0: trading_pair.first(), contribution_0: dollar(trading_pair.first()), currency_1: trading_pair.second(), contribution_1: dollar(trading_pair.second())}.into());
	}

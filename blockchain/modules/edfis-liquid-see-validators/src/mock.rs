...
//! Mocks for Edfis Liquid SEE Validator List Module.
...
mod edfis_liquid_see_validator_list {
	pub use super::super::*;
}
...
parameter_types! {
	...
	pub const GetLiquidCurrencyId: CurrencyId = LSEE;
}

pub type NativeCurrency = orml_currencies::BasicCurrencyAdapter<Runtime, PalletBalances, Amount, BlockNumber>;
pub type LSEECurrency = orml_currencies::Currency<Runtime, GetLiquidCurrencyId>;
...
construct_runtime!(
	pub enum Runtime {
		...
		EdfisLiquidSeeValidatorsModule: edfis_liquid_see_validator_list,
	}
);
...
impl Default for ExtBuilder {
	fn default() -> Self {
		Self {
			balances: vec![(ALICE, LSEE, 1000), (BOB, LSEE, 1000)],
		}
	}
}

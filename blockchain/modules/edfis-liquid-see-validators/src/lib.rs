...
//! # Edfis Liquid SEE Validator List Module
//!
//! ## Overview
//!
//! This will require validators to lock some Liquid SEE into insurance fund
//! and if slash happened, EthicalDeFiCouncil can burn those Liquid SEE to compensate
//! Liquid SEE holders.
...
pub const EDFIS_LIQUID_STAKING_VALIDATOR_LIST_ID: LockIdentifier = *b"edf/lqdseevld";

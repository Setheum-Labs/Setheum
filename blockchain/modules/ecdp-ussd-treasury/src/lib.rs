...
//! ## Overview
//!
//! The ECDP USSD Treasury manages the accumulated interest and bad debts generated by ECDPs,
...
use module_support::{AuctionsManager, SlickUsdEcdpTreasury, SlickUsdEcdpTreasuryExtended, SwapManager, Ratio, Swap, SwapLimit};
...
pub mod module {
	...
	impl<T: Config> Pallet<T> {
		...
		pub fn auction_collateral(
			...
			T::UpdateOrigin::ensure_origin(origin)?;
			let created_auctions = <Self as SlickUsdEcdpTreasuryExtended<T::AccountId>>::create_collateral_auctions(
				currency_id,
				amount,
				target,
				Self::account_id(),
...
impl<T: Config> SlickUsdEcdpTreasury<T::AccountId> for Pallet<T> {
...
impl<T: Config> SlickUsdEcdpTreasuryExtended<T::AccountId> for Pallet<T> {
	#[transactional]
